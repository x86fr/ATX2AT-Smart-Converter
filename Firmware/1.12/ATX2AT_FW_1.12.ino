...
void loop() {
  ...
  if(cur_5v > 9.0 || ((cur_5v > max_5v) && !slowblow) || ((cur_5v > (max_5v * 1.75)) && slowblow)) { 
      // if current > 9.0A OR fast blow mode and current limit exceeded OR slowblow and current limit + 125% => trigger immediatly 
      ocurrent5 = true; 
  ...
  if(cur_12v > 5.0 || ((cur_12v > max_12v) && !slowblow) || ((cur_12v > (max_12v * 1.75)) && slowblow)) { 
